    ...
    return (
        <section className="relative py-10 overflow-hidden bg-[#0a0a0a]">
            ...
            <div className="relative max-w-7xl mx-auto px-6 z-10">
                ...
                <motion.h2
                    className="text-4xl text-center md:text-5xl font-bold text-white mb-4 leading-tight"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.7, delay: 0.1 }}
                    viewport={{ once: true }}
                >
                    Smart Digital Services That
                    <span className="text-[#00A693]"> Grow Your Business</span>
                </motion.h2>

                <motion.p
                    className="max-w-3xl text-center mx-auto text-gray-300 text-lg mb-14"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.7, delay: 0.2 }}
                    viewport={{ once: true }}
                >
                    From AI-powered automation to high-converting ads and websites, we build systems
                    that attract leads, automate follow-ups, and scale revenue.
                </motion.p>
