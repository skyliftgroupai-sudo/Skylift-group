...
export const routeSeo = {
  "/": {
    title: "AI Marketing for Home Services | Sky Lift Group",
    description:
  ...
  "/services/local-maps": {
    title: "Google Maps Ranking & Map Pack SEO | Sky Lift Group",
    description:
  ...
  "/services/social-media": {
    title: "Social Media Management for Contractors | Sky Lift Group",
    description:
  ...
  "/services/ppc-management": {
    title: "PPC Management for Contractors | Sky Lift Group",
    description:
  ...
  "/services/content-writing": {
    title: "SEO Content Writing for Contractors | Sky Lift Group",
    description:
  ...
  "/services/meta-ads": {
    title: "Facebook Ads for Contractors | Sky Lift Group",
    description:
  ...
  "/services/one-click-campaigns": {
    ...
    description:
      "Launch email, SMS, and social campaigns for your home service business in one click. Ready-to-send offers built and automated by Sky Lift Group.",
  },
  "/services/tiktok-ads": {
    title: "TikTok Ads for Home Service Businesses | Sky Lift Group",
    description:
  ...
  "/services/reviews": {
    title: "Review Generation for Contractors | Sky Lift Group",
    description:
  ...
  "/services/ai-workflows": {
    title: "AI Workflow Automation for Contractors | Sky Lift Group",
    description:
  ...
  "/services/ai-voice-agents": {
    title: "AI Voice Agents for Home Service Businesses | Sky Lift Group",
    description:
  ...
  "/services/ai-chatbots": {
    title: "AI Chatbots for Home Service Businesses | Sky Lift Group",
    description:
  ...
  "/privacy-policy": {
    ...
    description:
      "How Sky Lift Group collects, uses, and protects the information you share with us.",
  },
  "/terms-conditions": {
